...
class FranquiaIntegradaController extends Controller
{
    ...
    public function index()
    {
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            return  view('franquia_integrada.index', 
                    array(
    ...
    public function busca (Request $request){
        if(!(Gate::denies('read_franquia'))){
            ...
            $franquias_remotas = DB::connection('mysql_loja')
                                        ->table('franquias')
                                        ->where('codigo_franquia', 'LIKE', '%'.$buscaInput.'%')
                                        ->orwhere('nome', 'LIKE', '%'.$buscaInput.'%')
                                        ->orwhere('slogan', 'LIKE', '%'.$buscaInput.'%')
                                        ->orwhere('descricao', 'LIKE', '%'.$buscaInput.'%')
                                        ->orderBy('id_7p')
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.busca=".$buscaInput);
            //--------------------------------------------------------------------------------------
    ...
    public function show(Franquia $franquia)
    {
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.show=".$franquia);
            //--------------------------------------------------------------------------------------
    ...
    public function create()
    {
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.create");
            //--------------------------------------------------------------------------------------
...
//
        if(!(Gate::denies('read_franquia'))){
            ...
            */
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.store=".$request);
            //--------------------------------------------------------------------------------------
    ...
    public function edit(Franquia $franquia)
    {
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.edit.id=".$franquia);
            //--------------------------------------------------------------------------------------
    ...
    public function update(Request $request, Franquia $franquia)
    {
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            */
            ...
            //LOG --------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.update=".$franquia);
            //------------------------------------------------------------------------------------    
    ...
    public function destroy(Franquia $franquia)
    {
        ...
        if(!(Gate::denies('delete_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.destroy=".$franquia);
            //--------------------------------------------------------------------------------------
    ...
    public function donos($id){
        ...
        if(!(Gate::denies('read_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.dono=".$franquia);
            //--------------------------------------------------------------------------------------
    ...
    public function donoUpdate(Request $request){
        ...
        if(!(Gate::denies('update_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.donoUpdate.id=".$franquia_id."Dono=".$dono_id);
            //--------------------------------------------------------------------------------------
    ...
    public function donoDestroy(Request $request){
        if(!(Gate::denies('delete_franquia'))){
            ...
            //LOG ----------------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.dono.destroy.id=".$franquia_id."Permission".$dono_id);
            //--------------------------------------------------------------------------------------------
    ...
    public function enable($id)
    {
        ...
        if(!(Gate::denies('update_franquia'))){
            ...
            //LOG --------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.status.1.=".$franquia);
            //------------------------------------------------------------------------------------    
    ...
    public function disable($id)
    {
        ...
        if(!(Gate::denies('update_franquia'))){
            ...
            //LOG --------------------------------------------------------------------------------
            $this->log("franquiaIntegrada.status.0.=".$franquia);
            //------------------------------------------------------------------------------------    
