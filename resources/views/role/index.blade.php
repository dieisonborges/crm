...
<h1>Role - Grupo 
    ...
    <a href="{{url('roles/create')}}" class="btn btn-info btn-lg"><i class="fa fa-plus"> </i> Novo</a>

    <a href="{{ url('permissions') }}" class="btn btn-primary btn-lg"><i class="fa fa-lock"> </i> Permissions</a>
