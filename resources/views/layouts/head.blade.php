<head>
  ...
  <link href="{{ asset('abower_components/font-awesome-5/css/fontawesome.css')}}" rel="stylesheet">
  <link href="{{ asset('abower_components/font-awesome-5/brands.css')}}" rel="stylesheet">
  <link href="{{ asset('abower_components/font-awesome-5/css/solid.css')}}" rel="stylesheet">
  <!-- Font Awesome 5.8.1 -->
  <!-- Instalar depois -->    
