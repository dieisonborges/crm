        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{URL::to('listaProspectos')}}/{{$lista_prospecto->id}}">{{$lista_prospecto->name}}</a>
                    </td>
                    <td>
                        <a href="{{URL::to('listaProspectos')}}/{{$lista_prospecto->id}}">{{$lista_prospecto->email}}</a>
                    </td>
                    <td>
                        <a href="{{URL::to('listaProspectos')}}/{{$lista_prospecto->id}}">{{$lista_prospecto->phone_number}}</a>
                    </td>                    
                </tr>                
                @empty
