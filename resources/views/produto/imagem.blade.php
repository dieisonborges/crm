                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        <tr class="border-yellow text-white">
                            ...
                            <td><a href="{{ url('produtos/'.$produto->id.'/imagemValor/'.$imagem_principal->id) }}" class="btn btn-info"><i class="fa fa-edit"></i> {{ $imagem_principal->valor }}</a></td> 
            ...
            <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td><a href="{{ url('produtos/'.$produto->id.'/imagemValor/'.$imagem->id) }}" class="btn btn-info"><i class="fa fa-edit"></i> {{ $imagem->valor }}</a></td> 
