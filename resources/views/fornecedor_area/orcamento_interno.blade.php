@can('read_fornecedor_area')  
    ...
    @section('content')
		...
		<div class="form-group col-md-12">	
			...
			<div class="box-body table-responsive no-padding">
			            <table class="table table-hover">
			                ...
			                <form method="POST" action="{{url('fornecedorArea/orcamentoUpdate')}}" id="orcamento_salvar">
		...
		@if(($orcamento->status==0)or($orcamento->status==1))
			...
			<a href="{{url('fornecedorArea/orcamentoFinalizar/'.$orcamento->id)}}" class="btn btn-primary"><i class="fa fa-check"></i> Finalizar Orçamento (Finalize Budget)</a>

			<a href="{{url('fornecedorArea/orcamentoShow/'.$orcamento->id)}}" class="btn btn-warning"><i class="fa fa-times-circle"></i> Remover Itens / Remove Items</a>
