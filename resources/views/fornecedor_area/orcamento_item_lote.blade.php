@can('create_orcamento')  
	...
	@section('content')
			<h1>
		        ...
		        <small>Orçamento / Budget: <b>{{$orcamento->codigo}}</b></small> 
		    </h1>
			

			<form method="POST" action="{{url('fornecedorArea/orcamentoItemLoteStore')}}" id="formSubmit">
				@csrf	

				<input type="hidden" name="orcamento_id" value="{{$orcamento->id}}">

				<div class="form-group col-md-12">
			        <label>Produtos / Products:</label>
			        <select name="produto_id[]" class="form-control select2" data-placeholder="Selecione um produto / Select a product" multiple="multiple" style="width: 100%;" required="required">
			    ...
			    <div class="form-group col-md-12">		
				 	...
				 	<div class="form-group col-md-2">
					    <label for="frete_tipo">Método de Envio<br> Shipping Method</label>
				 	...
				 	<div class="form-group col-md-2">
					    <label for="moeda">Moeda <br> Currency</label>
			 	...
			 	<div class="col-md-12">
			 		...
			 		<input type="submit" form="formSubmit" class="btn btn-primary" value="Adicionar Item / Add Items
">
			 		<hr>
