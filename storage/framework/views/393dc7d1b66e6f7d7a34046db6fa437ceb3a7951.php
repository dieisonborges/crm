<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update_atendimento')): ?>   
	...
	<?php $__env->startSection('title', 'Adicionar Ação ao Tecnico'); ?>
	<?php $__env->startSection('content'); ?>
			...
			<form method="POST" enctype="multipart/form-data" action="<?php echo e(url('atendimentos/storeAcao')); ?>" id="form-edit">
				<?php echo csrf_field(); ?>
