            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('password.request')); ?>" aria-label="<?php echo e(__('Reset Password')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nova Senha')); ?></label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Confirme a Nova Senha')); ?></label>
