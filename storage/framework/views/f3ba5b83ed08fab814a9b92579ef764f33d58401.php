...
<?php $__env->startSection('content'); ?>
	...
	<div class="row">
        ...
        <div class="box-body col-md-2">              
            ...
            <?php if($imagem): ?>  
                <img src="<?php echo e(url('storage/'.$imagem->dir.'/'.$imagem->link)); ?>" width="100%">
            <?php else: ?>
                <img src="<?php echo e(asset('img/default-user-image.png')); ?>" width="100%">
            <?php endif; ?>
        ...
        <div class="box-body col-md-6"> 
            ...
            <?php if($franqueadoVip): ?>               
            <div class="col-md-6"> 
                <img src="<?php echo e(asset('img/conquistas/conquistas-vip.png')); ?>" width="100%" alt="VIP">
            </div>
            <?php endif; ?>

            <?php if($franqueadoVip): ?>
            <?php if($franqueadoVip->lider): ?>
            <div class="col-md-6"> 
                <img src="<?php echo e(asset('img/conquistas/conquistas-lider.png')); ?>" width="100%" alt="Líder">
            </div>
            <?php endif; ?>
            <?php endif; ?>
          ...
          <ul class="timeline">
            ...
            <li>
              ...
              <div class="timeline-item">
                <span class="time"><i class="fa fa-clock"></i> <?php echo e(date('H:i:s', strtotime($user->created_at))); ?></span>
            ...
            <?php $__currentLoopData = $scores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li>
                  ...
                  <div class="timeline-item">
                    <span class="time"><i class="fa fa-clock"></i> <?php echo e(date('H:i:s', strtotime($score->created_at))); ?></span>
