        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo e(URL::to('atendimentos/'.$setor->name.'/'.$ticket->id.'/alocarSetors')); ?>"><i class="fa fa-group"></i> Setor</a>
                    </td>                    
