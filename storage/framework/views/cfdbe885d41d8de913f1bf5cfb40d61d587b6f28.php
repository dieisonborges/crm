<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read_ticket')): ?>   
    ...
    <?php if(($ticket->status)==1): ?>
    <section class="content">
      <a href="<?php echo e(URL::to('tickets')); ?>/<?php echo e($ticket->id); ?>/acao"  class="btn btn-info btn-md"><i class="fa fa-plus-circle"></i> Nova Ação</a>

      <a href="<?php echo e(URL::to('tickets')); ?>/<?php echo e($ticket->id); ?>/encerrar" class="btn btn-danger btn-md"><i class="fa fa-times-circle"></i> Encerrar Ticket</a>
    </section>
    <?php else: ?>
