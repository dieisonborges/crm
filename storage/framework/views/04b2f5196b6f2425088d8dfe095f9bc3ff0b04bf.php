        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo e(URL::to('user/'.$user->id.'/convites')); ?>"> <?php echo e($user->qtd_convites); ?></a>
                    </td>
                    <td>
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo e(URL::to('user/'.$user->id.'/setors')); ?>"><i class="fa fa-building"></i> Setor</a>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <form method="POST" action="<?php echo e(action('UserController@destroy', $user->id)); ?>" id="formDelete<?php echo e($user->id); ?>">
                            ...
                            <a href="javascript:confirmDelete<?php echo e($user->id); ?>();" class="btn btn-danger btn-xs"> <i class="fa fa-times-circle"></i> Excluir</a>
                        </form> 
