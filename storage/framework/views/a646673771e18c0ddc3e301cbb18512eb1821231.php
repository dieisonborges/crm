<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read_atendimento')): ?>  
    ...
    <h1>Setor(es) de Trabalho Associados ao Ticket <small><?php echo e($ticket->protocolo); ?></small></h1>
        ...
        <div class="col-md-12">  
            <form method="POST" action="<?php echo e(action('AtendimentoController@setorUpdate')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="ticket_id" value="<?php echo e($ticket->id); ?>">
                <input type="hidden" name="my_setor" value="<?php echo e($my_setor); ?>">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="<?php echo e(action('AtendimentoController@setorDestroy')); ?>" id="formDelete<?php echo e($setor->id); ?>">
                            <?php echo csrf_field(); ?>
