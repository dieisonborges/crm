<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('read_atendimento')): ?>    
    ...
    <h1>Tickets</h1>
        ...
        <div class="col-md-12"> 
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('atendimentos/'.$setor->name.'/busca')); ?>">
                <?php echo csrf_field(); ?>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(URL::to('atendimentos')); ?>/<?php echo e($setor->name); ?>/<?php echo e($ticket->id); ?>/show"><?php echo e($ticket->categorias['nome']); ?></a></td>
                    <td>
                        <a href="<?php echo e(URL::to('atendimentos')); ?>/<?php echo e($setor->name); ?>/<?php echo e($ticket->id); ?>/show">
                            <!--
