        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary btn-xs" href="<?php echo e(URL::to('produtos')); ?>/<?php echo e($produto->id); ?>/categorias">
                            <i class="fas fa-object-group"></i> Catego.                    
                        </a>
                    </td> 
                    <td>
                    ...
                    <td>
                        ...
                        <form method="POST" action="<?php echo e(action('ProdutoController@destroy', $produto->id)); ?>" id="formDelete<?php echo e($produto->id); ?>">
                            ...
                            <a href="javascript:confirmDelete<?php echo e($produto->id); ?>();" class="btn btn-danger btn-xs"> <i class="fas fa-times-circle"></i> Desativar</a>
                        </form> 
